...
import com.swiftconductor.core.execution.mapper.DecisionTaskMapper;
import com.swiftconductor.core.execution.mapper.DynamicTaskMapper;
import com.swiftconductor.core.execution.mapper.EventTaskMapper;
import com.swiftconductor.core.execution.mapper.ForkJoinDynamicTaskMapper;
import com.swiftconductor.core.execution.mapper.ForkJoinTaskMapper;
import com.swiftconductor.core.execution.mapper.HTTPTaskMapper;
import com.swiftconductor.core.execution.mapper.JoinTaskMapper;
import com.swiftconductor.core.execution.mapper.SimpleTaskMapper;
import com.swiftconductor.core.execution.mapper.SubWorkflowTaskMapper;
import com.swiftconductor.core.execution.mapper.SwitchTaskMapper;
import com.swiftconductor.core.execution.mapper.TaskMapper;
import com.swiftconductor.core.execution.mapper.UserDefinedTaskMapper;
import com.swiftconductor.core.execution.mapper.WaitTaskMapper;
import com.swiftconductor.core.execution.tasks.Decision;
import com.swiftconductor.core.execution.tasks.Join;
import com.swiftconductor.core.execution.tasks.Switch;
...
import static com.swiftconductor.common.metadata.tasks.TaskType.DECISION;
import static com.swiftconductor.common.metadata.tasks.TaskType.DYNAMIC;
import static com.swiftconductor.common.metadata.tasks.TaskType.EVENT;
import static com.swiftconductor.common.metadata.tasks.TaskType.FORK_JOIN;
import static com.swiftconductor.common.metadata.tasks.TaskType.FORK_JOIN_DYNAMIC;
import static com.swiftconductor.common.metadata.tasks.TaskType.HTTP;
import static com.swiftconductor.common.metadata.tasks.TaskType.JOIN;
import static com.swiftconductor.common.metadata.tasks.TaskType.SIMPLE;
import static com.swiftconductor.common.metadata.tasks.TaskType.SUB_WORKFLOW;
import static com.swiftconductor.common.metadata.tasks.TaskType.SWITCH;
...
import static com.swiftconductor.common.metadata.tasks.TaskType.TASK_TYPE_SWITCH;
import static com.swiftconductor.common.metadata.tasks.TaskType.USER_DEFINED;
import static com.swiftconductor.common.metadata.tasks.TaskType.WAIT;
