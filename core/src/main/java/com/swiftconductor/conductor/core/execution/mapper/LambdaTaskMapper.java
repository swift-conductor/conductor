...
/**
 * @author x-ultra
 * @deprecated {@link com.swiftconductor.core.execution.tasks.Lambda} is also deprecated. Use {@link
 *     com.swiftconductor.core.execution.tasks.Inline} and so ${@link InlineTaskMapper} will be used
 *     as a result.
 */
@Deprecated
@Component
