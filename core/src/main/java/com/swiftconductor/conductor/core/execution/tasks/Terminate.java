...
import static com.swiftconductor.conductor.common.metadata.tasks.TaskType.TASK_TYPE_TERMINATE;
import static com.swiftconductor.conductor.common.run.Workflow.WorkflowStatus.*;
